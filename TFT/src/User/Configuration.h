...
//                       PLA      PETG       ABS
#define PREHEAT_BED      {60,      90,       100}
#define PREHEAT_HOTEND   {205,     235,      230}
...
#define EXTRUDE_FAST_SPEED      2000
...
#define NOZZLE_PAUSE_X_POSITION     (X_MIN_POS + 2)  // (mm) Must be an integer
